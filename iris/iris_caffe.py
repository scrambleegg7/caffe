...
def main():
    ...
    tdir = "./"
    # Set parameters
    solver_prototxt_filename = tdir + 'iris_solver.prototxt'
    train_test_prototxt_filename = tdir + 'iris_train_test.prototxt'
    deploy_prototxt_filename  = tdir + 'iris_deploy.prototxt'
    #deploy_prototxt_filename  = tdir + 'iris_deploy.prototxt'
    deploy_prototxt_batch2_filename  = tdir + 'iris_deploy_batchsize2.prototxt'
    hdf5_train_data_filename = tdir + 'iris_train_data.hdf5' 
    hdf5_test_data_filename = tdir + 'iris_test_data.hdf5' 
    caffemodel_filename = tdir + 'iris__iter_500000.caffemodel' # generated by train()
